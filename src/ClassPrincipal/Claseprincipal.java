...
import ConversorDivisas.ConversionesOpciones;
import ConvertirTemperatura.ConversionOpcionesTemperatura;
...
public class Claseprincipal {
	...
	public static void main(String[] args) {
		...
		ConversionesOpciones conversion = new ConversionesOpciones();
		ConversionOpcionesTemperatura conversionT = new ConversionOpcionesTemperatura();
